...
app.post("/submit", (req, res) => {
  ...
  var lengthOfAdj = adj.length;
var lengthOfNoun = noun.length;
var adjRandom = Math.floor(Math.random()*lengthOfAdj);
var nounRandom = Math.floor(Math.random()*lengthOfNoun);
  name = adj[adjRandom] + noun[nounRandom];
  console.log(name);
